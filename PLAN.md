...
### PR #11 검증 기준
- [x] 프롬프트에서 travel_time 검증 관련 내용 수정됨 ✅
- [x] "travel_time은 참고용, 실제값은 Routes API로 대체" 명시됨 ✅
- [x] 검증 체크리스트에서 travel_time 항목 제거됨 ✅
- [x] PLAN.md에 PR #8-11 내용 추가됨 ✅
- [x] 성공 기준 명확히 정의됨 ✅
